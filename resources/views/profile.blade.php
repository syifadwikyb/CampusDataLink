    ...
    <div class="flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
        <aside class="py-4 md:w-1/3 lg:w-1/4">
            ...
            <div id="dropdown-menu"
                class="flex-col hidden gap-2 p-4 text-sm border-r border-indigo-100 md:block md:sticky lg:flex top-12">
                <a href="#"
                    ...
                    <div class="grid mx-auto mt-8">
                        <div class="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                            ...
                            <div class="flex flex-col space-y-5 sm:ml-8">
                                <form action="{{ route('profile.change-picture') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" name="profile_picture" id="profile_picture">
                                    <button type="submit"
                                        class="py-3.5 px-7 text-base font-medium text-indigo-100 focus:outline-none bg-[#202142] rounded-lg border border-indigo-200 hover:bg-indigo-900 focus:ring-4 focus:ring-indigo-200">
                                        Change picture
                                    </button>
                                </form>
                            ...
                            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-2 sm:mb-6">
                                    <label for="phone_number"
                                        class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">Phone
                                        Number</label>
