...
<body class="bg-white dark:bg-slate-900 font-montserrat">
    ...
    <div class="container mx-auto px-6 py-8">
        <h1 class="text-center font-bold text-5xl text-dark dark:text-white mb-12">Tutorial</h1>

        <div class="grid gap-8">
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Kustom Link</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
                        <img src="{{ asset('asset/kustomLink.png') }}" alt=""
                            class="w-full h-auto object-cover rounded-lg">
                    </div>
                    <p class="lg:w-2/3 text-dark dark:text-white text-sm md:text-base lg:text-lg text-center md:text-center lg:text-left">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Banner</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Profil</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
                        <img src="{{ asset('asset/banner.png') }}" alt=""
                            class="w-full h-auto object-cover rounded-lg">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Judul</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Tentang</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Sosial Media</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Tombol</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Latar Belakang</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Font</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800">
                <h1 class="font-bold text-dark dark:text-orange-500 text-2xl mb-4 text-center md:text-center lg:text-left">Gaya Tombol</h1>
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    <div class="lg:w-1/3">
