...
<body class="bg-white dark:bg-slate-900 font-montserrat">
    ...
    <div class="container px-6 py-8 mx-auto">
        <h1 class="mb-12 text-5xl font-bold text-center text-dark dark:text-white">Tutorial</h1>

        <div class="grid gap-8">
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Kustom Link</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
                        <img src="{{ asset('asset/kustomLink.png') }}" alt=""
                            class="object-cover w-full h-auto rounded-lg">
                    </div>
                    <p class="text-sm text-center lg:w-2/3 text-dark dark:text-white md:text-base lg:text-lg md:text-center lg:text-left">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Banner</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Profil</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
                        <img src="{{ asset('asset/banner.png') }}" alt=""
                            class="object-cover w-full h-auto rounded-lg">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Judul</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Tentang</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Sosial Media</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Tombol</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Latar Belakang</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Font</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <h1 class="mb-4 text-2xl font-bold text-center text-dark dark:text-orange-500 md:text-center lg:text-left">Gaya Tombol</h1>
                <div class="flex flex-col items-center justify-between gap-6 lg:flex-row">
                    <div class="lg:w-1/3">
