        ...
        <div class="flex items-center justify-between">
            <div class="relative">
                ...
                <div id="dropdown-menu"
                    ...
                    <a href="{{ route('home') }}"
                        class="flex justify-center w-full py-2 mb-1 font-bold rounded-lg dark:text-white hover:text-white hover:bg-purple-700 dark:hover:bg-orange-500">Home</a>
                    ...
                    <a href="{{ route('tutorial') }}"
                        class="flex justify-center w-full py-2 mb-1 font-bold rounded-lg dark:text-white hover:text-white hover:bg-purple-700 dark:hover:bg-orange-500">Tutorial</a>
