<div
    class="mx-auto overflow-hidden rounded-3xl border-8 border-dark bg-black w-[380px] xl:w-[380px] h-[800px] mt-6 xl:mt-0">
    ...
    <div class="display px-3 pt-2 my-auto h-full max-h-[670px] mb-0 w-full bg-white flex-grow-1 rounded-b-2xl">
        ...
        <h1 class="mb-2 text-xl font-bold text-center break-words whitespace-normal Title">Title</h1>
        <p class="mb-4 text-center break-words whitespace-normal About">About goes here.</p>
