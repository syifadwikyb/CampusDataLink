...
<div class="flex-grow max-w-full p-8 shadow-2xl customizations">
    ...
    <div class="flex-grow mb-3">
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="flex items-center my-auto mb-0 space-x-2 rounded-lg h-11">
                ...
                <textarea class="flex-grow w-full h-full max-h-full min-h-full p-2 border text-dark dark:text-white bg-white dark:bg-slate-900 border-gray-300 dark:border-orange-300 rounded-lg" id="slugInput"
    ...
    <div class="flex space-x-6">
        <div class="w-1/2">
            ...
            <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg mb-">
                <div class="flex flex-col justify-between mb-0 overflow-hidden border border-gray-300 dark:border-orange-300 rounded-lg h-14">
        ...
        <div class="w-1/2">
            ...
            <div class="p-3 mb-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
                <div class="flex flex-col justify-between mb-0 overflow-hidden border border-gray-300 dark:border-orange-300 rounded-lg h-14">
                    <div class="flex flex-col justify-end h-full p-2 space-y-2 mb" action="">
                        <div class="flex justify-center md:space-x-2 md:justify-end">
                            <h1 class="hidden mx-auto my-auto font-light text-center text-gray-400 md:block">Ukuran
    ...
    <div class="flex-grow mb-3">
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="flex mb-0 space-x-2 h-11">
                <textarea maxlength="100" class="flex-grow w-full h-full max-h-full min-h-full p-2 border text-dark dark:text-white bg-white dark:bg-slate-900 border-gray-300 dark:border-orange-300 rounded-lg"
    ...
    <div class="flex-grow mb-3">
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="flex mb-0 space-x-2 rounded-lg h-28">
                <textarea class="flex-grow w-full h-full max-h-full min-h-full p-2 bg-transparent border text-dark dark:text-white bg-white dark:bg-slate-900 border-gray-300 dark:border-orange-300 rounded-lg"
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="grid grid-cols-6 mb-2 space-x-2 sm:grid-cols-10 lg:grid-cols-cb">
                <input type="text" id="newLinkInput"
                    class="flex-grow h-full col-span-3 p-2 bg-transparent border text-dark dark:text-white bg-white dark:bg-slate-900 border-gray-300 dark:border-orange-300 rounded-lg sm:col-span-5 lg:col-span-10"
                    placeholder="Enter Link">
                <select id="newIconSelect"
                    class="flex-grow h-full col-span-2 p-2 bg-transparent border text-dark dark:text-white bg-white dark:bg-slate-900 border-gray-300 dark:border-orange-300 rounded-lg sm:col-span-4 lg:col-span-5">
                ...
                <button onclick="generateLinkInput()">
                    <i class="block py-2 text-white bg-purple dark:bg-orange-500 rounded-lg bi bi-plus-lg"></i>
                </button>
            </div>
            <div id="linkInputs" class="mt-2 space-y-2 text-dark dark:text-orange-500 bg-white dark:bg-slate-900">
                @foreach ($socialButtons as $index => $socialButton)
                    <div class="grid grid-cols-6 mb-2 space-x-2 sm:grid-cols-10 lg:grid-cols-cb link-input-item"
                        data-id="{{ $index }}">
                        <input type="text"
                            class="flex-grow h-full col-span-3 p-2 bg-transparent border border-gray-300 dark:border-orange-300 rounded-lg sm:col-span-5 lg:col-span-10"
    ...
    <div class="flex-grow mb-3">
        ...
        <div class="flex-1 p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="grid grid-cols-6 mb-2 space-x-2 sm:grid-cols-10 lg:grid-cols-cb">
                <input type="text"
            ...
            <div id="linkContainers" class="space-y-2 text-dark dark:text-orange-500 bg-white dark:bg-slate-900">
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
            <div class="grid w-full grid-cols-3 mx-auto gap-x-2 md:grid-cols-6">
                ...
                <x-button class="w-full py-2 text-white bg-gradient-to-tr from-gray-900 to-slate-700"
                    ...
                    Black-Gray </x-button>
                <x-button class="w-full py-2 bg-gradient-to-tr from-purple to-purple dark:from-orange-500 dark:to-orange-500" onclick="openWarna()">Custom </x-button>
            </div>
            <div id="modalWarna" class="fixed inset-0 items-center justify-center hidden bg-gray-800 bg-opacity-75">
                <div class="w-1/3 mx-auto mt-[30vh] bg-white dark:bg-slate-900 rounded-lg shadow-lg">
                    <span class="text-5xl text-dark dark:text-white cursor-pointer flex justify-end pr-8 close"
                    ...
                    <div class="flex justify-around pb-5">
                        ...
                        <div>
                            <label for="gradient-direction" class="block mb-2 font-semibold text-dark dark:text-white">Gradient Direction</label>
                            <select id="gradient-direction" class="w-full p-2 border rounded" onchange="applyCustomBackground()">
    ...
    <div class="flex-grow mb-3">
        ...
        <div class="p-3 bg-white dark:bg-slate-900 rounded-lg shadow">
