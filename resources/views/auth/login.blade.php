    ...
    <div data-aos="flip-right" data-aos-duration="1000" class="container mx-auto">
        <div class="flex items-center justify-center my-auto">
            <form class="lg:p-16 md:p-10 sm:p-10 p-5 shadow-2xl rounded-xl bg-customgradient3 dark:bg-customgradient1"
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <div class="flex shadow-sm">
                            ...
                            <span
                                class="icon-eye cursor-pointer py-3 px-5 rounded-r-xl bg-white text-purple dark:text-orange-500"
                ...
                <button class="bg-light font-bold text-center mt-10 py-3 px-5 w-full text-purple rounded-xl hover:bg-white dark:text-dark dark:hover:bg-orange-500">
                    Login
                </button> 
            </form>
        </div>
