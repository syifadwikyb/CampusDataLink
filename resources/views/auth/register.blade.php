            ...
            <div class="relative">
                ...
                <div class="flex md:hidden md:space-x-4">
                    ...
                    <div id="dropdown-menu"
                        class="hidden absolute right-0 mt-10 w-48 bg-slate-100 dark:bg-slate-700 rounded-lg shadow-lg">
                        <a href="/login"><button
    ...
    <div data-aos="flip-left" data-aos-duration="1000" class="container mx-auto w-full">
        <div class="flex items-center justify-center my-auto">
            <form class="lg:p-16 md:p-10 sm:p-10 p-5 bg-customgradient3 dark:bg-customgradient1 shadow-2xl rounded-xl"
                ...
                @csrf
                <h1 class="lg:text-5xl text-4xl font-bold leading-6 text-center text-white mb-8 dark:text-white">
                    Register</h1>
                    ...
                    <div class="mt-2">
                        <div class="flex shadow-sm">
                            <input type="email" name="email" id="email" autocomplete="email"
                                value="{{ old('email') }}"
                                class="form-control rounded-xl flex-1 bg-light py-3 px-5 text-dark font-semibold placeholder:text-abu focus:outline-none sm:text-base sm:leading-6 dark:bg-white dark:text-dark"
                    ...
                    <div class="mt-2">
                        <div class="flex shadow-sm">
                            <input id="password" type="password"
                                class="form-control rounded-l-xl flex-1 bg-light py-3 px-5 text-dark font-semibold placeholder:text-abu focus:outline-none sm:text-base sm:leading-6 dark:bg-white dark:text-dark"
                                name="password" required autocomplete="new-password" placeholder="Masukkan password">
                            <span
                                class="icon-eye cursor-pointer py-3 px-5 rounded-r-xl bg-light text-purple dark:text-orange-500 dark:bg-white">
                ...
                <div class="sm:col-span-4 mb-2">
                    <label
                        ...
                        class="block lg:text-lg text-base font-bold leading-6 text-white dark:text-white">Confirm
                        Password</label>
                    <div class="mt-2">
                        <div class="flex shadow-sm">
